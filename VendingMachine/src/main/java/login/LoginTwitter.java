...
public class LoginTwitter {
    ...
    public void testNGAsserts() throws Exception{
        ...
        FileInputStream fs = new FileInputStream("./src/test/resources/LoginTwitter.xlsx");
       ...
       // System.setProperty("webdriver.gecko.driver","./driver/geckodriver.exe");
        ...
        // ExtentReports
        ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("LoginTwitter.html");
  ...
  //  Assert.assertEquals(title2, "Log in | Boilerplate-NoCoding-Template");
   // Thread.sleep(3000);
        ...
        logStep.info("Step 2: Open Twitter Login");       
        driver.findElement(By.xpath("//*[@id='auth0-Twitter-login-button']")).click();
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//*[@id='layers']/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div/div[5]/label/div/div[2]/div/input")).sendKeys(user);
